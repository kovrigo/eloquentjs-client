...
var Builder = (function () {
    ...
    _createClass(Builder, [{
        key: 'find',
        value: function find(id, columns) {
            if (Array.isArray(id)) {
        ...
        key: 'findMany',
        value: function findMany(ids, columns) {
            return this.query._call('findMany', ids).get(columns);
        }
    }, {
        key: 'findOrFail',
        value: function findOrFail(id, columns) {
...
var Model = (function () {
    ...
    _createClass(Model, [{
        ...
        value: function getDirty() {
            ...
            return (0, _lodash.omit)(this.getAttributes(), function (value, prop) {
                return _this.original[prop] == value;
            });
        }
    }], [{
        key: 'where',
...
},{"./Builder":2,"lodash":1}],4:[function(require,module,exports){
'use strict';
...
var _EloquentModel = require('./Eloquent/Model');

var _EloquentModel2 = _interopRequireDefault(_EloquentModel);
...
var Manager = (function () {
    ...
    function Manager(BaseModel) {
        ...
        this.baseModel = BaseModel || _EloquentModel2['default'];
    }
    ...
    _createClass(Manager, [{
        ...
        value: function named(name) {
            var registration = this.getRegistryItem(name);
        ...
        key: 'getRegistryItem',
        value: function getRegistryItem(name) {
            return (0, _lodash.find)(this.registry, 'name', name);
        }
        ...
        value: function createDefinition(factory) {
            var baseClass = this.baseModel;
            return factory((function (_baseClass) {
...
},{"./Eloquent/Model":3,"lodash":1}],5:[function(require,module,exports){
'use strict';
